 ...
 *
 * 	The resource server is located at "/gift", and can be accessed only by retrieving a token from "/oauth/token"
...
public class OAuth2SecurityConfiguration {
	 ...
	 *	resource server (i.e. the "/gift" endpoint) 
	 */
	@Configuration
	...
	protected static class ResourceServer extends
		...
		public void configure(HttpSecurity http) throws Exception {
			...
			http
			.authorizeRequests()
				.antMatchers(HttpMethod.POST, "/gift/**")
	...
	protected static class OAuth2Config extends
		...
		public OAuth2Config() throws Exception {
			...
			InMemoryUserDetailsManager svc = new InMemoryUserDetailsManager(
					Arrays.asList(
							User.create("admin", "pass", "ADMIN", "USER"),
							User.create("user", "pass", "USER")));
...
//		}
		 ...
		 */
		@Bean
		public ClientAndUserDetailsService userDetailsService() {
			return combinedService_;
		}
